...
rule fastqc_raw_pe:
	input:
		r1=expand("data/ST/{sample}_1.fastq.gz", sample=config["Samples"]),
		r2=expand("data/ST/{sample}_2.fastq.gz", sample=config["Samples"])
	output:
...
rule trim_pe:
	input:
		r1="data/ST/{sample}_1.fastq.gz",
		r2="data/ST/{sample}_2.fastq.gz"
	output:

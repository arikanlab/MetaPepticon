...
rule fastqc_raw_pe:
	input:
		r1=expand("data/MG/{sample}_1.fastq.gz", sample=config["Samples"]),
		r2=expand("data/MG/{sample}_2.fastq.gz", sample=config["Samples"])
	output:
...
rule trim_pe:
	input:
		r1="data/MG/{sample}_1.fastq.gz",
		r2="data/MG/{sample}_2.fastq.gz"
	output:
